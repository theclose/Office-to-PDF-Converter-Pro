"""
Auto-generated tests for build_exe (v3.1 - Class-Aware)
Generated: 2025-12-27T00:19:13.702598
...
try:
    ...
    pytest.skip(f"Cannot import from build_exe: {e}")

# Test for build (complexity: 9, coverage: 0%, priority: 0.61)
...
# Test for clean (complexity: 4, coverage: 0%, priority: 0.52)
...
# Test for get_data_files (complexity: 3, coverage: 0%, priority: 0.50)
...
# Test for main (complexity: 3, coverage: 0%, priority: 0.50)
...
# Test for create_version_info (complexity: 1, coverage: 0%, priority: 0.47)
...
# Test for get_hidden_imports (complexity: 1, coverage: 0%, priority: 0.47)
...
# Test for get_excludes (complexity: 1, coverage: 0%, priority: 0.47)
