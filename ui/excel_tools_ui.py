...
class ExcelToolsDialog(ctk.CTkToplevel, ExcelToolsOpsMixin):
    """Modern Excel Tools dialog. Processing logic in ExcelToolsOpsMixin."""
    ...
    # are inherited from ExcelToolsOpsMixin
